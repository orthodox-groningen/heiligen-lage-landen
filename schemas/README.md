...
| `betekenis` | Feest: 1–3 alinea’s geheim + leiding (vaders/dienstboek primair; grootfeesten, Pascha, Heilige Week, kernfeesten, Triodion-zondagen, Thomas–Blinde, Midden-Pinksterfeest) | Heilige (`betekenis_lage_landen`); herhaling van `verhaal`; voorfeest/nafeest/synaxis/weken; tweede vastentabel |
