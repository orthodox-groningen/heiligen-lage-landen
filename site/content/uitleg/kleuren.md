...
één regel. Zie [Vasten]({{% ref "/uitleg/vasten" %}}) en
[Datumpagina’s]({{% ref "/uitleg/datumpagina" %}}).

## Voor wie de site bijhoudt

Welk gegeven de kleur bepaalt, staat op de
[technische pagina bij deze uitleg]({{% ref "/uitleg/kleuren-technisch" %}}).
